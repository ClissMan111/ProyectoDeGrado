...
<body class="public-body">
    ...
    <div class="utility-bar">
        <div class="container utility-inner">
            ...
            <span>Atención según horarios disponibles</span>
        </div>
    </div>
    <header class="site-header" data-header>
        <div class="container header-inner">
            ...
            <nav class="main-nav" id="main-nav" data-nav>
                ...
                <a class="{{ request()->routeIs('about') ? 'active' : '' }}" href="{{ route('about') }}">Acerca de nosotros</a>
    ...
    <footer class="site-footer">
        <div class="container footer-grid">
            ...
            <div><h2>Atención</h2><a href="{{ route('about') }}">Acerca de nosotros</a><a href="{{ route('specialties') }}">Especialidades</a><a href="{{ route('how-it-works') }}">Cómo reservar</a><a href="{{ route('faq') }}">Preguntas frecuentes</a></div>
